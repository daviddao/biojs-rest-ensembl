...
describe('BioJS2 REST', function () {
	...
	describe('Genomic alignment blocks', function () {
	    ...
	    it ("Has the correct url", function () {
		assert.equal(aln_block_url, "http://rest.ensembl.org/alignment/region/homo_sapiens/1:10604000-10604150.json?method=LASTZ_NET&species_set=human&species_set=mouse");
	    });
